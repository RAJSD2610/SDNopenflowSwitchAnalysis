...
10.bash snaptry.sh
11.python Instantplot.py #plot current data
12.create a directory and transfer files from directory PlotDump to it
13.Inculde the path to all your data directories in  FinalPlot.py
11.python FinalPlot.py #plots the statistics for all your full runs
